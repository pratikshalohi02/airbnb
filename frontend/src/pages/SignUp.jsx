  ...
  return(
   <div className='w-[100vw] h-[100vh] flex items-center justify-center relative'>
    ...
    <form action="" className="max-w-[900px] w-[90%]  h-[600px] flex items-center justify-center flex-col md:items-start gap-[10px]" onSubmit={handleSignUp}>
      ...
      <input type="text" id='name' className="w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[20px] px-[20px]" required onChange={(e)=>setName(e.target.value)}
      value={name} />
      </div>
       <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] ">
      <label htmlFor="email" className="text-[20px]">Email</label>
      <input type="text" id='email' className="w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[20px] px-[20px]" required onChange={(e)=>setEmail(e.target.value)}
      value={email}/>
      </div>
      ...
      <input
       type={show?"text":"password"}
        id="password" 
        className="w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[20px] px-[20px] appearance-none" required onChange={(e)=>setPassword(e.target.value)}
      value={password} />
      ...
      <button className="px-[50px] py-[10px] bg-[red] text-[white] text-[18px] md:px-[100px] rounded-lg mt-[20px]" disabled={loading}>{loading?"Loading....." : "SignUp"}
      </button>
