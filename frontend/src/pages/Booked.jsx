...
<div className="w-[100vw] min-h-[100vh] flex items-center justify-center gap-[10px] bg-slate-200 flex-col">
  <div className="w-[95%] max-w-[500px] h-[400px] bg-[white] flex items-center justify-center border-[1px] border-[#b5b5b5] flex-col gap-[10px] p-[20px] md:w-[80%] rounded-lg">
...
<div className="w-[100%] flex items-center justify-between text-[16px] md:text-[18px]">
  ...
  <Star onRate={handleStar}/>
   <button  className="px-[30px] py-[10px] bg-[red] text-white text-[18px] md:px-[100px] rounded-lg text-nowrap"
