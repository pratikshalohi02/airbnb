  ...
  return(
   <div className='w-[100vw] h-[100vh] flex items-center justify-center relative'>
    ...
    <form action="" className="max-w-[900px] w-[90%]  h-[600px] flex items-center justify-center flex-col md:items-start gap-[10px]" onSubmit={handleLogin}>
      ...
      <input type="text" id='email' className="w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[20px] px-[20px]" required onChange={(e)=>setEmail(e.target.value)} value={email} />
      </div>
      ...
      <input
       type={show?"text":"password"}
        id="password" 
        className="w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[20px] px-[20px] appearance-none" required onChange={(e)=>setPassword(e.target.value)} value={password}/>
