...
let result = await axios.post(serverUrl + `/api/listing/delete/${cardDetails._id}`,formData,{withCredentials:true})
console.log(result)
...
<div className="w-[95%] flex items-start justify-start text-[18px] md:w-[80%] md:text-[25px] ">{`${cardDetails.title.toUpperCase()} ${cardDetails.Category.toUpperCase()} , ${cardDetails.landMark.toUpperCase()}`}
</div>

<div className="w-[95%] flex items-start justify-start text-[18px] md:w-[80%] md:text-[25px] text-gray-800">{cardDetails.description}
</div>

<div className="w-[95%] flex items-start justify-start text-[18px] md:w-[80%] md:text-[25px]">{`Rs.${cardDetails.rent}/day`}
</div>
<div className="w-[95%] h-[15px] flex items-center justify-start px-[100px] mt-5 gap-[40px]">
...
Reserve
  ...
  {/* Update Listing Page*/}
 {updatePopUp && (
  <div className="fixed inset-0 flex items-center justify-center bg-[#000000a6] z-[100] backdrop-blur-sm">
    {/* Modal / update form here */}
   ...
   <form action="" className="max-w-[900px] w-[90%]  h-[550px] flex items-center justify-start flex-col  gap-[10px] overflow-auto mt-[50px] text-white bg-[#272727] p-[20px] rounded-lg" onSubmit={(e)=>{e.preventDefault()}}>
      ...
      <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] ">
        <label htmlFor="title" className="text-[20px] mt-7">Title</label>
      ...
      <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] ">
        ...
        <input type="number" id='rent' className="w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px]  text-[black]" placeholder="Rs.______/day" onChange={(e)=>setRent(e.target.value)} value={rent}/>
      </div>
      <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] ">
        <label htmlFor="city" className="text-[20px]">City</label>
        <input type="text" id='city' className="w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px]  text-[black]" placeholder="city,country" onChange={(e)=>setCity(e.target.value)} value={city}/>
      </div>
      <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] ">
        <label htmlFor="landmark" className="text-[20px]">Landmark</label>
        <input type="text" id='landmark' className="w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px]  text-[black]" onChange={(e)=>setLandmark(e.target.value)} value={landmark}/>
      </div>
...
{bookingPopUp &&<div className="fixed inset-0 flex items-center justify-center bg-[#ffffffcd] z-[100] backdrop-blur-sm overflow-auto ">
   ...
   <div className="flex flex-col md:flex-row items-start justify-center gap-6 w-full max-w-[1000px]">
<form className="max-w-[450px] w-[90%] h-[450px] overflow-auto border-[#dedddd] bg-[#f7fbfcfe] p-[20px] rounded-lg flex items-center justify-start flex-col gap-[10px] border-[1px]  " onSubmit={(e)=>{
  e.preventDefault()
}}>
...
<div className="w-[90%] flex items-center justify-start gap-[24px] md:items-start mt-[20px] md:justify-center md:flex-row flex-col ">
        <label htmlFor="checkIn" className="text-[18px] md:text-[20px]">CheckIn</label>
        <input type="date" min={minDate} id='checkIn'  className="w-[200px] h-[40px] border-[2px] border-[#555656] rounded-[10px] text-[15px] px-[10px] md:text-[18px]  bg-transparent" required onChange={(e)=>setCheckIn(e.target.value)} value={checkIn}/>
</div>
<div className="w-[90%] flex items-center justify-start gap-[10px] md:items-start mt-[40px] md:justify-center md:flex-row flex-col ">
        <label htmlFor="checkOut" className="text-[18px] md:text-[20px]">CheckOut</label>
        <input type="date"  min={minDate} id='checkOut' className="w-[200px] h-[40px] border-[2px] border-[#555656] rounded-[10px] text-[15px] px-[10px] md:text-[18px]  bg-transparent" required onChange={(e)=>setCheckOut(e.target.value)} value={checkOut}/>
</div>
...
<div className="max-w-[450px] w-[90%] h-[450px] bg-[#f7fbfcfe] p-[20px] rounded-lg flex items-center justify-center flex-col gap-[10px] border-[1px] border-[#e2e1e1] ml-6 ">
