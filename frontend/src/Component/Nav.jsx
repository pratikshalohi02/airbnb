...
handleSearch(input)
     ...
     <div className="fixed top-0 bg-[white] z-[20]" >
      ...
      <div className="flex items-center justify-center gap-[10px] relative">
        ...
        <button className="px-[20px] py-[10px] flex items-center justify-center gap-[5px] border-[1px] border-[#8d8c8c] rounded-[50px] hover:shadow-lg" onClick={()=>{setShowpopup(prev=>!prev) }}>
         ...
         {showpopup && <div className="w-[220px] h-[250px] absolute bg-slate-50 top-[110%] right-[3%] border-[1px] border-[#aaa9a9] z-10 rounded-lg md:right-[10px]">
 ...
 <div className="w-[80%] relative">
    ...
    <div className="w-[100vw] h-[85px] bg-white flex items-center justify-start cursor-pointer  
    gap-[40px] overflow-auto md:justify-center px-[15px] ">
